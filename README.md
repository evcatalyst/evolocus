...
- Browser visual-route verification from `visual_smoke.json`; this records workflow status for public progressive routes, currently Chart -> Map -> Inquiry -> Ontology and ontology tier share URLs.
