...
- Browser visual-route verification from `visual_smoke.json`; this records workflow status for public progressive routes, currently Chart -> Map -> Inquiry -> Ontology, ontology tier share URLs, latest-analysis Ask-this-map-layer, question-to-map highlight depth, and selected-unit ontology route comparison.
