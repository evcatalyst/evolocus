...
- Browser visual-route verification from `visual_smoke.json`; this records workflow status for public progressive routes, currently Chart -> Map -> Inquiry -> Ontology, ontology tier share URLs, and latest-analysis Ask-this-map-layer.
